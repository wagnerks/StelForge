# 🌌 Stellar Forge Engine (aka STELFORGE ENGINE // SFE)

![logo](https://github.com/user-attachments/assets/ffc7df08-5f86-4f00-b4c7-d3d97fef0a91)
...
- [x] Entity Component System (ECS) with **Data-Oriented Design**
- [x] OpenGL Scene Rendering
- [x] 3D Models Loading (.obj)
- [x] ImGui Integration
- [x] Deferred Shading Pipeline
- [x] Directional Light with Shadow Mapping (Ortho)
- [x] Point Light Support
- [x] Frustum Culling
- [x] Level of Detail (LOD)
- [x] HDR Rendering
- [x] Object Selection (click-based picking)
- [x] Outlines
- [x] Custom Shader Injection for Drawables
